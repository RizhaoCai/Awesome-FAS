# Face Anti-Spoofing / Presentation Attack Detection (Type 1 — Physical Attacks)

Part of [Awesome Face Authentication Security](./README.md). This page collects resources for **face anti-spoofing / presentation attack detection (PAD)** — detecting physical artefacts *presented to the capture sensor* (print, replay, 3D mask), i.e. **Type 1** attacks as defined by ISO/IEC 30107. For digital/injection (deepfake) attacks see [Deepfake / Face Forgery Detection](./Deepfake-Detection.md); for methods that detect both, see [Unified Attack Detection](./README.md#unified-type-1--type-2-attack-detection).

# Contents
- [Databases](#databases)
- [Learning-based methods](#learning-based-methods)
  - [Year 2026](#year-2026) · [2025](#year-2025) · [2024](#year-2024) · [2023](#year-2023) · [2022](#year-2022) · [2021](#year-2021) · [2020](#year-2020) · [2019-2018](#year-2019-2018) · [Before 2018](#before-2018)
...
# Notes
The venue glossary (T-PAMI, T-IFS, T-IP, T-DSC, T-BIOM, CVPR, ICCV, ECCV, AAAI, IJCAI, NeurIPS, ICLR, ACM MM, IJCB, NDSS, USENIX SS, etc.) is shared with the main [README](./README.md#notes).
